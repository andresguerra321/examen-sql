...
(3, 1, 1), (3, 3, 1), (3, 6, 4), (3, 8, 1); -- Familiar (Pepperoni + Pollo + 4 Coca colas + Brownie)
...
(2, DATE_SUB(NOW(), INTERVAL 10 DAY), 'Recoger', 12000.00), 
(3, DATE_SUB(NOW(), INTERVAL 14 DAY), 'Local', 45000.00);  


-- Pedido 1: (Recoger, 30k) -> Pizza Hawaiana (22k) + Adicion + Bebida (4k)
...
-- Pedido 2:  (Local, 40k) -> 2 Panzarottis Rancheros (18k) + Adicion + Cerveza (8k) + Postre (7.5k)
(3, 2, 5, 2, 9000.00),
(4, 2, 9, 1, 8000.00),
(5, 2, 8, 1, 7500.00),
-- Pedido 3:  (Recoger, 12k) -> 1 Panzarotti Mixto (8k) + Bebida (4k) + extra queso
(6, 3, 4, 1, 8000.00),
(7, 3, 6, 1, 4000.00),
-- Pedido 4:  (Recoger, 25k) -> Pizza Pepperoni (25k) SIN ADICIÓN
(8, 4, 1, 1, 25000.00),
-- Pedido 5:  (Local, 50k) -> 2 Pizzas Hawaianas (44k) + 1 Coca Cola (4k) + Adición (2k)
(9, 5, 2, 2, 22000.00),
(10, 5, 6, 1, 4000.00),
-- Pedido 8:  (Recoger, 28k) -> Pizza Pollo y Champiñones + Salsa
(11, 8, 3, 1, 26000.00),
-- Pedido 9:  (Local, 15k) -> Panzarotti Ranchero + Bebida
(12, 9, 5, 1, 9000.00),
(13, 9, 6, 1, 4000.00);
...
-- Pedido 7:  (Local, $65000) -> 1 Combo Familiar
INSERT INTO pedido_combo (id_pedido, id_combo, cantidad, precio_unitario) VALUES
(7, 3, 1, 65000.00),
-- Pedido 6:  (Recoger, 15k) -> 1 Combo Personal + Bebida extra
(6, 1, 1, 10000.00),
-- Pedido 10:  (Recoger, 35k) -> 1 Combo Pareja + 1 Panzarotti Ranchero (9k)
(10, 2, 1, 26000.00),
-- Pedido 11:  (Recoger, 12k) -> 1 Combo Personal + salsa
(11, 1, 1, 10000.00),
-- Pedido 12:  (Local, 45k) -> 1 Combo Pareja + Pizza Hawaiana
(12, 2, 1, 26000.00);
